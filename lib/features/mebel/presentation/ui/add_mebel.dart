...
class AddMebel extends StatefulWidget {
  const AddMebel({super.key});

  @override
  State<AddMebel> createState() => _AddMebelState();
}

class _AddMebelState extends State<AddMebel> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          context.read<MebelController>().addMebel(
              _name.text,
              _selectedItem,
              _description.text,
